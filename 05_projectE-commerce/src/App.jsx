  ...
  if (!isAuthenticated) {
    return (
      <div className="card mx-auto mt-10 max-w-xl text-center">
        ...
        <p className="mt-2 text-slate-500">Please click Login in the navbar to simulate admin authentication.</p>
      </div>
    )
  }
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/products/test" element={<ProtectedRoute><TestPage /></ProtectedRoute>} />
